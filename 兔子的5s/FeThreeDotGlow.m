...
-(void) initLabel
{
    ...
    // set center
    _label.center = CGPointMake(self.center.x, self.center.y  + kPagingLabel + _label.bounds.size.height / 2);
...
-(void) resetLabel
{
    ...
    _label.center = CGPointMake(self.center.x, self.center.y   + 30 + _label.bounds.size.height / 2);
}
